...
x = SavingsAccount("Murthy",5000,5)
x.printof()
...
C = Account("Murthy",2000)
C.deposit(500)
C.get_balance()
c1 = Account("Murthy",2000)
c1.withdraw(500)
c1.get_balance()
...
demo1 = SavingsAccount("Murthy", 2000, 5) 
